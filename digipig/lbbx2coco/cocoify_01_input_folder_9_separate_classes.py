...
cocoDestFile = "02_output/batch1_coco_images_no_annotations_9classes.json"    #   "coco_template.json"
...
category_id_enum = {
    ...
    "pig-lying-good-visibility":2,
    "pig-standing-bad-visibility":3,
    "pig-standing-good-visibility":4,
    "face-good-visibility":5,
    "face-bad-visibility":6,
    "tail-curl-standing":7,
    "tail-straight-standing":8,
    "tail-uncertain-or-lying":9,
}
...
with open("02_output/batch1_coco_9classes"+dt_string+".json", 'w') as wf:
